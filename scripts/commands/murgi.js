...
module.exports.run = async function({ api, args, Users, event}) {
		...
		if(!mention) return api.sendMessage("বস যে মেয়েকে চুদতে চাউ সে মেয়েকে @ম্যানশন দেউ", event.threadID);
...
setTimeout(() => {a({body: "Hiফারহান এর জারজ মেয়ে মাগির মেয়ে  💔!" + " " + name, mentions: arraytag})}, 9000);
